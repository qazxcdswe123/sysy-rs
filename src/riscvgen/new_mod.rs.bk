...
//         self.curr_time += 1;
//         let mut curr_min = std::i32::MAX;
//         let mut possible: Option<usize> = None;
//         for i in REGISTER_FOR_TEMP {
//             match self.register_user[i] {
//                 Some(_) => {
//                     if self.register_used_time[i] < curr_min {
//                         curr_min = self.register_used_time[i];
//                         possible = Some(i);
//                     }
//                 }
//                 None => return i,
...
//     fn find_register(&self, value: Value) -> Option<usize> {
//         for i in 0..32 {
//             if self.register_user[i] == Some(value) {
//                 return Some(i);
//             }
//         }
//         None
